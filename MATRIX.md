...
| priority | work |
|---|---|
| 1 | Performance probing is closed after the rev-7 Rust PGO floor check and A.2 fair C PGO/matched-heap matrix. Do not chase M1/M2 or more R1/dispatch variants unless they fall out of simplification for free |
