...
| post-simplification full self-host refresh | after `40f94481`, `18c5581b`, and `79e5de80`, current default release at the 128M speed window completed 3x byte-identically: `58.478s`, `85.425s`, `58.841s` (median `58.841s`, noisy avg `67.581s`; sample 2 is a wall-time outlier with the same steps/GC/high-water shape), `3,659,074,736` steps, `31` GCs, GC pauses `8.818s`, `8.805s`, `8.839s` (avg `8.821s`), high-water `138,068,132`, sink `661902`, `cell_size_bytes=8`, SHA `29b8c5a55e0952bd25a9a06d5723033e0367ebaf53cfd598fa00f8e65a80d98a`, `cmp=0` for all three. Reading: current source is still in the ~59s band; not a new source-speed claim because the changes are profiling/simplification cleanup |
