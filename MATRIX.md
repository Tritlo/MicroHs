...
| parity state | benchmark and smoke sinks match; Rust self-host compile produces byte-identical output. Current runtime uses unconditional 8-byte cells. Latest current-source 128M full self-host gate after the rev-5 profile cfg-gate and eval-module merge is 3x byte-identical at `53.636s`, `53.501s`, `53.813s` (median `53.636s`, avg `53.650s`), `3,659,074,926` steps, `31` GCs, median GC pause `8.655s`, high-water `138,068,148` cells, output SHA `29b8c5a55e0952bd25a9a06d5723033e0367ebaf53cfd598fa00f8e65a80d98a`, and `cell_size_bytes=8`. The later R1 dirty-card work was feature-only, rejected, and reverted; default source is now in the low-54s/high-53s band. Most recent fairer-memory 80Mi interval median is `55.926s` with high-water `88.15M` 8-byte cells and 49 GCs. Fresh C oracle full self-host is `47.85s`; older historical gates remain recorded below |
