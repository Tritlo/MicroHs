...
| parity state | benchmark and smoke sinks match; Rust self-host compile produces byte-identical output. Current runtime uses unconditional 8-byte cells. Latest current-source 128M full self-host refresh after the stale GC young-profile trim is 3x byte-identical at `56.364s`, `55.941s`, `56.133s` (median `56.133s`, avg `56.146s`), same `3,659,074,983` steps, `31` GCs, high-water `138,068,158` cells, output SHA `29b8c5a55e0952bd25a9a06d5723033e0367ebaf53cfd598fa00f8e65a80d98a`, and `cell_size_bytes=8`. Previous post-moving refresh was `57.065s`, `56.166s`, `56.753s` (median `56.753s`, avg `56.661s`); treat the current refresh as the same mid-56s band, not a new source-speed claim. Latest paired accepted 128M gate remains the free-slot allocation cleanup: candidate median `58.044s` and avg `58.040s` versus same-session baseline median `57.939s` and avg `58.084s` (`+0.18%` median, `-0.08%` avg). Treat that as neutral cleanup; the previous R5 sweep free-node row is the latest source-speed claim. Most recent fairer-memory 80Mi interval median is `68.975s` with high-water `88.15M` 8-byte cells and 49 GCs. Fresh C oracle full self-host is `47.85s`; older historical gates remain recorded below |
