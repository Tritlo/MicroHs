...
| next moving prototype | a cheaper old-to-young source must avoid a branch in every hot app rewrite. Given S4 and the rejected exact remembered-source probe, prefer a coarse card/line dirtying scheme, allocation-site-specific old-update hooks, or periodic old-space compaction over precise setter barriers; keep the nursery suffix/evacuation machinery as the correctness base |
