...
| accepted native default | changed the non-WASI default `GC_NODE_INTERVAL` from `32M` to `128M`, leaving `MHS_GC_NODE_INTERVAL` as an override and keeping the WASI default at `500k`. A no-env release self-host gate reproduced the interval-probe result byte-identically in `62.207s`, `3,659,074,983` steps, `58.82M` steps/s, `31` GCs, `10.350s` GC pause, high-water `138.07M` cells, SHA `29b8c5a55e0952bd25a9a06d5723033e0367ebaf53cfd598fa00f8e65a80d98a`, `cmp_exit=0` |
