...
| post-simplification full self-host refresh | after `160386da`, `b2d80d38`, and `828aa1d6`, current default release at the 128M speed window completed 3x byte-identically: `59.709s`, `59.686s`, `58.970s` (median `59.686s`, avg `59.455s`), `3,659,074,717` steps, `31` GCs, GC pauses `8.718s`, `8.723s`, `8.698s` (avg `8.713s`), high-water `138,068,130`, sink `661902`, `cell_size_bytes=8`, SHA `29b8c5a55e0952bd25a9a06d5723033e0367ebaf53cfd598fa00f8e65a80d98a`, `cmp=0` for all three. Reading: current source is still in the ~59s band; not a new source-speed claim because the changes are default-inert/test-or-feature cleanup |
